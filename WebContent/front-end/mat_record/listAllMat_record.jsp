...
<%
    ...
    List<Mat_recordVO> list = mat_recordSvc.getAll();
...
<html>
<head>
<title>所有員工資料 - listAllMat_record.jsp</title>
...
<!-- 			<td> -->
<%-- 			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/mat_record/mat_record.do" style="margin-bottom: 0px;"> --%>
