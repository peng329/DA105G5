...
<%
	...
	List<LessonOrderVO> list = lessonorderSvc.getAll();
...
<head>
<meta charset="UTF-8">
<title>所有潛店課程 - list All Dive Shop Lesson Order.jsp</title>
...
<body>
	...
	<table>
		<tr><td>
			<h3>所有課程資料 - list All Dive Shop Lesson Order.jsp</h3>
...
<table>
	...
	<c:forEach var="lessonOrderVO" items="${list}" begin="<%=pageIndex %>" end="<%=pageIndex+rowsPerPage-1%>">
		<tr ${(lessonOrderVO.les_o_no==param.les_o_no) ? 'bgcolor=#CCCCFF':'' }>
			...
			<td>
				<form METHOD="post" action="<%=request.getContextPath()%>/lessonorder/lessonorder.do" style="margin-bottom: 0px;">
