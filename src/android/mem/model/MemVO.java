...
public class MemVO  implements java.io.Serializable{
	...
	public MemVO(String mem_no, String mem_id, String mem_psw, String mem_name, Integer mem_sex, Date mem_bd,
			String mem_mail, String mem_phone, String mem_add, byte[] mem_pic, Timestamp reg_time, Integer mem_rep_no,
			String mem_state) {
		super();
		this.mem_no = mem_no;
		this.mem_id = mem_id;
