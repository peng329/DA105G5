...
Set<Agp_List_VO> list = dao.findMemState("待審核");
pageContext.setAttribute("list",list);


// Set<Agp_List_VO> JoinManagementToLeader =(Set) request.getAttribute("JoinManagementToLeader");
// pageContext.setAttribute("JoinManagementToLeader",JoinManagementToLeader);

Set<Act_List_VO> JoinManagementToLeader =(Set) request.getAttribute("JoinManagementToLeader");
pageContext.setAttribute("JoinManagementToLeader",JoinManagementToLeader);

System.out.println("Size = " + JoinManagementToLeader.size());
                                       ...
                                       <thead>
	                                      <tr>
											...
											<th>審核</th>
										 		...
										 		<c:forEach var="agp_list_vo" items="${list}" >
												<c:forEach var="act_list_vo" items="${JoinManagementToLeader}">
												
												
												<c:if test="${act_list_vo.act_list_no eq agp_list_vo.act_list_no}">
												...
												<tr>
													...
													<td>
													  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/agp_list/agp_list.do" style="margin-bottom: 0px;">
													     <input type="submit" class="btn btn-outline-info" value="審核">
