...
<%
	EqpicVO eqpicVO = (EqpicVO) request.getAttribute("ds_no");
...
<table>
	...
	<c:forEach var="eqpicVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			<td>${eqpicVO.ep_seq}</td>
			<td><img src="<%=request.getContextPath()%>/PrintPic?epic_seq=${eqpicVO.epic_seq}" width="100px" height="100px"></td>
				<td>
