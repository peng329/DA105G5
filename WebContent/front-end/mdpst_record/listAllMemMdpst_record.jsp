...
<% 
    List<Mdpst_recordVO> list = (List<Mdpst_recordVO>)request.getAttribute("list");
...
<html>
<head>
<title>所有員工資料 - listAllMdpst_record.jsp</title>
		...
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/front-end/mdpst_record/mdpst_record.do" style="margin-bottom: 0px;">
			     ...
			     <input type="hidden" name="mem_no"  value="${mdpst_recordVO.mem_no}">
			     <input type="hidden" name="dp_no"  value="${mdpst_recordVO.dp_no}">
