    ...
    <div class="container" id="memLogin">
        ...
        <form name="login" action="" method="post">
            <div class="input-group">
                ...
                <input type="text" name="mem_id" class="form-control" placeholder="帳號" style="ime-mode:inactive"/>
            </div><br />
            <div class="input-group">
                <div class="input-group-prepend">
            ...
            <br />
            <button type="submit" class="btn btn-success" onclick="memLogin()";><span class="glyphicon glyphicon-off"></span>會員登入</button>
            <br>
            <br />
            <center>
            ...
            <div class="footer">
                <p>Don't have an Account! <a href='<%=request.getContextPath()%>/front-end/mem/addMem.jsp'>會員註冊</a>
...
function memLogin(){ 
    document.login.action="<%=request.getContextPath()%>/loginhandler";
