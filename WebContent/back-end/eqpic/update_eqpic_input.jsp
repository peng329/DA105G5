...
<title>圖片修改 - update_eqpic_input.jsp</title>
...
<body bgcolor='white'>
	...
	<table id="table-1">
		<tr>
			<td>
				<h3>圖片修改 - update_eqpic_input.jsp</h3>
				<h4>
	...
	<FORM METHOD="post" ACTION="eqpic.do" name="form1" enctype="multipart/form-data">
		<table>
			<tr>
				<td>裝備流水號:<font color=red><b>*</b></font></td>
				<td><%=eqpicVO.getEp_seq()%></td>
			</tr>
			<tr>
				<td>圖片:</td>
				<td><input type="file" name="epic" id="ppic"> <img
					id="img" width="150px" height="150px"></td>
			</tr>
		</table>
		<br> <input type="hidden" name="action" value="update"> <input
			type="hidden" name="epic_seq" value="<%=eqpicVO.getEpic_seq()%>">
