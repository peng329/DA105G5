...
<link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/creditcard/style.css">

</head>

<body>
<div class="container" style="position:relative;margin:auto;">
	<div class="row" style="position:relative;font-size:40px;">
		資策會金流服務平台 
	</div>
	
	<div class="row"  style="postition:relative;margin-left:25%;">
		<div class="wrapper" id="app" style="margin-top:0%;padding-top:1%;">
    <div class="card-form">
      <div class="card-list">
      ...
      <div class="card-form__inner">
		...
		<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/ROrder/rorder.do" name="formPay">
			<input type="hidden" name="mem_no" value="${memVO.mem_no}"> 
			<input type="hidden" name="ro_no" value="${ro_no}"> 
			<input type="hidden" name="action" value="getPayInfo"> 
	        <input type="submit" value="送出" onclick="executeExample('normalAlert')">
	    </FORM>
      </div>
    </div>
  </div>
