        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card card-signin person-card my-6">
                    <div class="card-body">
                        <img id="img_sex" class="person-img" src="<%=request.getContextPath()%>/front-end/mem/images/2x.gif">
                        ...
                        <div class="forgotpw" class="container">
                            ...
                            <form class="form-signin" method="post" action="<%=request.getContextPath()%>/diveshop/diveshop.do" name="form1" enctype="multipart/form-data">
		                                ...
		                                <div class="row">
		                                    <div class="col-md-6" >  
		                                        <input  name="address" id="address"  class="form-control twaddress"  value="<%=(diveshopVO == null) ? "台中市霧峰區光明路27巷28號" : diveshopVO.getAddress()%>">
                                        ...
                                        <p>
                                            <input type="text" id="ds_latlng" name="ds_latlng" class="form-control" placeholder="" autofocus value="<%=(diveshopVO == null) ? "" : diveshopVO.getDs_latlng()%>">
                                        </p>
...
<%--------------peng改的，註冊成功後彈窗 --------------中央路300號---------------------------%>
	<c:if test="${not empty message}">
	
		<script type="text/javascript">

                //alert範例
                swal("註冊成功", "註冊成功，請等待平台管理員審核資格，謝謝!", "success").then(function(){
...
$(document).ready(function(){
	$("#magic").click(function(){
		...
		$("#ds_latlng").val("")
		$("#dsaccount").val("123456")
		$("#dspaw").val("123456")
		$("#dsmail").val("xxx@mail.com")
		$("#dsinfo").val("優質潛水中心")
	});
});
</script>
