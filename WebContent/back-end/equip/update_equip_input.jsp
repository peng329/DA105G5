	...
	<div class="container">
		...
		<div class="row">
			<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/Equip/equip.do" name="form1">
				...
				<div class="row form-group">
					 ...
					 <div class="col-9 col-md-8">
						<select name="ep_state" id="ep_state" class="form-control">
							...
							<option value="待查驗 "${(equipVO.ep_state=="待查驗")? 'selected':'' } >待查驗
				...
				<div class="row form-group">
					    ...
					    <div class="col-9 col-md-8">
							 <select name="epr_state" id="select" class="form-control">
									...
									<option value="出租" ${(equipVO.epr_state=="出租")? 'selected':'' } >出租
							  </select>
					     </div>
				</div>
				...
				<input type="submit" value="送出修改" class="btn btn-outline-info btn-lg">
			</FORM>
		</div>	
	</div>
	<!-- Scripts -->
